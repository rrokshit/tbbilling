...
class MealVoucherController extends Controller
{
	...
	{
		/*$dataProvider=new CActiveDataProvider('MealVoucher');
	...
	{
		$model=new MealVoucher('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MealVoucher']))
			$model->attributes=$_GET['MealVoucher'];
	...
	{
		$model=MealVoucher::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='meal-voucher-form')
		{

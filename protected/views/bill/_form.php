                                ...
                                <div class="forms">
                                    ...
                                    <table style="width: 70%">
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="inputs">
                                                        <span class="input_wrapper blank"><?php echo $form->dropDownList($model, 'title', array('Mr.' => 'Mr.', 'Ms.' => 'Ms.', 'Mrs.' => 'Mrs.', 'M/s' => 'M/s'), array('size' => 1, 'maxlength' => 10, 'class' => 'text')); ?></span>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="inputs blank">
                                                        <span class="input_wrapper"><?php echo $form->textField($model, 'clinetName', array('size' => 60, 'maxlength' => 100, 'class' => 'text', 'style'=>'height=88px')); ?></span>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="row">
                                                    <?php echo $form->labelEx($model, 'clinetAddress'); ?>
                                                    <div class="inputs">
                                                        <span class="blank"><?php //echo $form->textArea($model, 'clinetAddress', array('size' => 60, 'maxlength' => 100, 'class' => 'text')); ?>
                                                        <?php 
                                                        if(isset($_GET['id'])){
                                                            $val = $model->clinetAddress;
                                                        }else{
                                                            $val='';
                                                        }
                                                        //$this->widget('application.extensions.tinymce.ETinyMce', array('name'=>'Bill[clinetAddress]','height'=>'40px','width'=>'520px','value'=>$val)); 
                                                    $this->widget('ext.niceditor.nicEditorWidget',array(
                                                            "model"=>$model,                // Data-Model
                                                            "attribute"=>'clinetAddress',        // Attribute in the Data-Model
                                                            "defaultValue"=>$val,
                                                            "config"=>array("maxHeight"=>"100px"),
                                                            "width"=>"520px",       // Optional default to 100%
                                                            "height"=>"100px",      // Optional default to 150px
                                                        ));
                                                        ?>
                                                        </span>
                                                        <span class="system negative"><?php echo $form->error($model, 'clinetAddress'); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <?php
                                                    if (isset($_GET['id']))
                                                        $dd = date("d-m-y", strtotime($model->arrivalDate));
                                                    else
                                                        $dd = date("d-m-y");
                                                    ?>
                                                    <div class="inputs">
                                                        <span class="input_wrapper"><?php echo $form->textField($model, 'arrivalDate', array('size' => 60, 'maxlength' => 100, 'class' => 'text', 'value' => $dd)); ?></span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="inputs">
                                                        <span class="input_wrapper"><?php echo $form->textField($model, 'voucherNo', array('size' => 60, 'maxlength' => 20, 'class' => 'text')); ?></span>
                                                        <span class="system negative"><?php echo $form->error($model, 'voucherNo'); ?></span>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="inputs">
                                                        <span class="input_wrapper"><?php echo $form->textField($model, 'RefNo', array('size' => 60, 'maxlength' => 20, 'class' => 'text')); ?></span>
                                                        <span class="system negative"><?php echo $form->error($model, 'RefNo'); ?></span>
                                                    </div>
                                    ...
                                    <table style="width:74%">
                                        <tr>
                                            <td>Service Tax</td>
                                            <td>
                                                <span class="input_wrapper blank"><?php echo $form->dropDownList($model, 'taxType', array('0' => 'NILL','1.236' => 'Hotel Only - 1.236%', '3.09' => 'Hotel + Transport + Guide - 3.09%', '4.80' => 'Guide + Transport (No Hotel) - 4.80%'), array('empty' => 'Select Tax Type'), array('size' => 1, 'maxlength' => 10, 'class' => 'text', 'options' => array($model->taxType => array('selected' => 'selected')))); ?></span>
                                            </td>

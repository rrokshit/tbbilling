                        ...
                        <div class="sct_right">
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'columns' => array(
                                    ...
                                    array(
                                        'name' => 'checkIn',
                                        'filter'=>$this->widget('zii.widgets.jui.CJuiDatePicker', array('model'=>$model, 'attribute'=>'checkIn','language'=>'ja','i18nScriptFile' => 'jquery.ui.datepicker-ja.js','defaultOptions'=>array('dateFormat'=>'dd-mm-yy','changeYear'=>'true','changeMonth'=>'true','showAnim' =>'slide',)), true),
                                        'value' => 'date("d-m-Y",strtotime($data->checkIn))',
                                    ),
                                    array(
                                        'name' => 'checkOut',
                                        'filter'=>$this->widget('zii.widgets.jui.CJuiDatePicker', array('model'=>$model, 'attribute'=>'checkOut','language'=>'ja','i18nScriptFile' => 'jquery.ui.datepicker-ja.js','defaultOptions'=>array('dateFormat'=>'dd-mm-yy','changeYear'=>'true','changeMonth'=>'true','showAnim' =>'slide',)), true),
                                        'value' => 'date("d-m-Y",strtotime($data->checkOut))',
                                    ),
                                    /*
                                      'confirmationNumber',
                                      'guestName',
                                    ...
                                    array(
                                        'class' => 'CButtonColumn',
                                        'template' => '{update}{view}{delete}{pdf}',
                                        'buttons' => array(
                                            'view' => array(
                                            ...
                                            'pdf' => array(
                                                'url' => 'Yii::app()->createUrl("voucher/pdf",array(id=>$data->voucherId))',
...
function reinstallDatePicker(id, data) {
    $('#Voucher_checkIn').datepicker();
    $('#Voucher_checkOut').datepicker();
}
");
                            ?>
                        </div>

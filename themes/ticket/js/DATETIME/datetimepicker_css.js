...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    if (UseImageFiles) {
			...
			vCalClosing += "<span onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' style='font-size:16px; font-weight:bold;'>X</span>";
	    }
	    else {

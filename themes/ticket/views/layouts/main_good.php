...
<!--[if !IE]>start wrapper<![endif]-->
	<div id="wrapper">
		...
		<div id="head">
			...
			<div id="menus_wrapper">
				...
				<div id="main_menu">
					<ul>
                        <li><a href="<?php echo Yii::app()->request->baseUrl.'/index.php'?>" <?php if(Yii::app()->controller->id=='site'){echo "class='selected'";}?>><span><span>Home</span></span></a></li>
						<?php
						...
						<!--<li><a href="<?php echo $this->createUrl('/management')?>" <?php if(Yii::app()->controller->id=='management' || Yii::app()->controller->id=='management' || Yii::app()->controller->id=='company' || Yii::app()->controller->id=='agents' || Yii::app()->controller->id=='sectors' || Yii::app()->controller->id=='carriers' || Yii::app()->controller->id=='prices' || Yii::app()->controller->id=='paymentTerms' || Yii::app()->controller->id=='banks'){echo "class='selected'";}?>><span><span>Management</span></span></a></li>
                        <li><a href="<?php echo $this->createUrl('/entry')?>" <?php if(Yii::app()->controller->id=='entry' || Yii::app()->controller->id=='entry' || Yii::app()->controller->id=='receipts' || Yii::app()->controller->id=='dueCollection' || Yii::app()->controller->id=='paymentVoucher' || Yii::app()->controller->id=='invoice' || Yii::app()->controller->id=='exchangeOrder'){echo "class='selected'";}?>><span><span>Entry</span></span></a></li>
                        <li><a href="<?php echo $this->createUrl('/report')?>" <?php if(Yii::app()->controller->id=='report' || Yii::app()->controller->id=='report' || Yii::app()->controller->id=='rptOfficialReceipt' || Yii::app()->controller->id=='rptReceiptSummary' || Yii::app()->controller->id=='rptDuePaymentCollection' || Yii::app()->controller->id=='rptApprovePaymentVoucher' || Yii::app()->controller->id=='rptPaymentVoucher' || Yii::app()->controller->id=='rptCollectionStatus' || Yii::app()->controller->id=='rptAuditReport' || Yii::app()->controller->id=='rptInvoice' || Yii::app()->controller->id=='rptXO'){echo "class='selected'";}?>><span><span>Report</span></span></a></li>
                        <li><a href="<?php echo $this->createUrl('/backup')?>" <?php if(Yii::app()->controller->id=='backup' || Yii::app()->controller->id=='backup' || Yii::app()->controller->id=='sysBackup' || Yii::app()->controller->id=='sysRestore'){echo "class='selected'";}?>><span><span>Backup</span></span></a></li>-->
										...
										<div class="sct_left">
											<div class="sct_right">
												<ul class="sidebar_menu">
													...
													<li><a href="<?php echo $this->createUrl('/entry')?>">Entry</a></li>
													<li><a href="<?php echo $this->createUrl('/report')?>">Report</a></li>
													<li><a href="<?php echo $this->createUrl('/backup')?>">Backup</a></li>
												</ul>
											</div>
										</div>
									</div>
	...
	<div id="footer">
		...
		<dl class="copy">
			<dt><strong>Developed By</strong> <a href="http://www.aspiringteam.com" target="_blank"><em>Aspiring Team Systems Pvt. Ltd.</em></a></dt>
			<dd>&copy; 2013 <?php echo Company::model()->findByPk(1)->name?>   All rights reserved.</dd>
		</dl>
		...
		<dl class="quick_links">
			...
			<dd>
				<ul>
                	<li><a href="<?php echo Yii::app()->request->baseUrl.'/index.php'?>" <?php if(Yii::app()->controller->id=='site'){echo "class='selected'";}?>>Home</a></li>
					<?php
						$menuItem = MenuItem::model()->findAll("parent='0'");
						foreach($menuItem as $menu)
						{
					...
					?>
                    <li><a href="<?php echo Yii::app()->request->baseUrl.'/index.php/site/logout'?>" <?php if(Yii::app()->controller->id=='site'){echo "class='selected'";}?>>Log out</a></li>
